...
// import '../views/controller/signUp_screen_controller.dart';
...
//
//                   const SizedBox(height: 16),
//                   CustomInputField(hintText: 'Enter confirm password', icon: Icons.lock, obscureText: true, controller: controller.confirmPasswordController),
//                   const SizedBox(height: 16),
...
class SignupScreenUi extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => ElevatedButton(
                    onPressed: controller.agreeToTerms.value ? controller.goToVerify : null,
                    style: ElevatedButton.styleFrom(
  ...
  Widget _buildGenderRadio(String value, SignUpScreenController controller) {
    return Row(
      children: [
        Radio<String>(
          value: value,
