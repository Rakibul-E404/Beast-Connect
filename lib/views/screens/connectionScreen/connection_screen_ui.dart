...
//                                 children: [
//                                   Container(
//                                     width: 24, // give explicit width
//                                     height: 24, // give explicit height to make it circular
//                                     decoration: BoxDecoration(
//                                       color: Colors.green, // or any visible color
//                                       borderRadius: BorderRadius.circular(30), // to make it circle-like
//                                     ),
//                                   ),
//                                 ],
//                               ),
...
//                                   color: Colors.white.withOpacity(0.1), // Semi-transparent glass effect
//                                   padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 6), // Keep original padding
//                                   child: Column(
//                                     children: [
//                                       Row(
//                                         children: [
