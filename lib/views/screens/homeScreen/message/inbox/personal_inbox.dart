              ...
              child: SafeArea(
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      ListTile(
                        leading: Icon(Icons.notifications,color: AppColors.primaryIconColor,),
                      ...
                      ListTile(
                        leading: Icon(Icons.block,color: AppColors.primaryIconColor),
                      ...
                      ListTile(
                        leading: Icon(Icons.delete,color: AppColors.primaryIconColor),
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            icon: Icon(Icons.call, color: AppColors.primaryIconColor),
          ...
          Builder(
            builder: (context) => IconButton(
              ...
              icon: Icon(Icons.more_vert, color: AppColors.primaryIconColor),
              padding: EdgeInsets.symmetric(horizontal: 8), // Compact padding
            ),
          ),
        ],
