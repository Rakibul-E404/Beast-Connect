...
//         elevation: 0,
//         toolbarHeight: 220, // Adjust height to fit search bar
//         flexibleSpace: Stack(
//           children: [
//             // Background vector image, moved up slightly
//             Positioned.fill(
...
//             ),
//
//             // AppBar main content (logo, title, icons)
//             Padding(
...
//
//                   // Middle: Search Bar Container (expanded)
//                   Expanded(
//                     child: Container(
...
//                   backgroundImage: NetworkImage(controller.popularConnections[0]['image'] as String),
//                 ),
//                 const SizedBox(width: 12),
//                 Expanded(
//                   child: Container(
...
//                                 Icon(
//                                   Icons.circle,
//                                   color: (user['active'] as bool) ? Colors.greenAccent : Colors.grey,
//                                   size: 12,
//                                 ),
...
//                 children: [
//                   // Large rectangular first image
//                   Container(
//                     width: screenWidth * 0.45,
//                     height: screenWidth * 0.25,
//                     margin: EdgeInsets.zero, // no margin, circle will touch here
//                     decoration: BoxDecoration(
//                       borderRadius: BorderRadius.circular(16),
//                       image: DecorationImage(
...
//                       itemBuilder: (context, index) {
//                         var imgIndex = index + 1; // skip first image
//                         return Container(
//                           width: screenWidth * 0.1,
//                           height: screenWidth * 0.1,
//                           margin: EdgeInsets.only(right: imgIndex == controller.nextEvents.length - 1 ? 0 : 1), // tiny gap or zero
//                           decoration: BoxDecoration(
//                             shape: BoxShape.circle,
//                             border: Border.all(color: Colors.black, width: 1.5),
//                             image: DecorationImage(
//                               image: NetworkImage(controller.nextEvents[imgIndex]['image'] as String),
//                               fit: BoxFit.cover,
//                             ),
//                           ),
//                         );
...
//                     width: screenWidth * 0.1,
//                     height: screenWidth * 0.1,
//                     margin: EdgeInsets.zero, // no gap, touch circle
//                     decoration: BoxDecoration(
//                       shape: BoxShape.circle,
...
//                             // Name and Challenge Point stacked vertically
//                             Expanded(
//                               child: Column(
...
//             ),
//
//             const SizedBox(height: 40), // Bottom padding for nav bar space
//           ],
//         ),
//       ),
//
