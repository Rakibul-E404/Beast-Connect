      ...
      builder: (context) {
        return ClipRRect(
          borderRadius: BorderRadius.only(
            topLeft: Radius.circular(20), // Adjust the curve radius as needed
            topRight: Radius.circular(20), // Adjust the curve radius as needed
          ),
          child: Container(
            padding: EdgeInsets.all(16),
            decoration: BoxDecoration(
              ...
              border: Border(
                top: BorderSide(
                  color: AppColors.primaryColor, // Set the color of the top border
                  width: 4.0, // Set the thickness of the top border
                ),
              ),
            ),
            child: Column(
